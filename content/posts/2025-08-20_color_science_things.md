...
-   XLog 曲线的图像可视化（Desmos）：<https://www.desmos.com/calculator/9pgjgo1gq4>
-   Google Colab 里对 XLog 曲线的数学推导和由来的记录，有很多讲解性的描述：<https://colab.research.google.com/drive/1NwjaD0NzNMzQeNQqZECj33PdcYGkeBM4>
    -   [A multiply in linear is equal to an addition in log!?](https://colab.research.google.com/drive/1NwjaD0NzNMzQeNQqZECj33PdcYGkeBM4#scrollTo=IiGLLRAoz2Cc&line=1&uniqifier=1)
...
> Scale
> Let's see what other variables we can add. If we add a scale for the input x and a scale for the output y this could be useful. This would allow us to control exposure of both input and output values.
>
> $$(y = s_y * \frac{x}{x + s_x})$$
>
...
-   [Juan Pablo Zambrano DaVinci DRT Implementation in Nuke](https://discuss.pixls.us/t/blender-agx-in-darktable-proof-of-concept/48697/662)
    -   <https://www.desmos.com/calculator/qkvcafnuzr>
-   [open-display-transform Wiki > Tonescale > Primate Cone Cells](https://github.com/jedypod/open-display-transform/wiki/tech_tonescale#primate-cone-cells)
