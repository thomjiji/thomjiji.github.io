...
#### always use `rm -i` {#always-use-rm-i}


#### 使用 `find ... -delete` 执行删除操作前，always 先 pipe 给 less 命令来查看将要删除哪些东西 {#使用-find-dot-dot-dot-delete-执行删除操作前-always-先-pipe-给-less-命令来查看将要删除哪些东西}
...
```bash
$ gdu -sbc --si '/Volumes/DIT-4T#16/241009-{project}/素材/'
395G    241009
184G    241020
853G    241022
137G    241027
...
$ gdu -sbc '/Volumes/DIT-4T#16/241009-{project}/素材/'
394135765498    241009
183963861229    241020
852788569255    241022
136063767206    241027
...
```bash
tree -P '*MP4' /Volumes/DIT-4T#20/250626-TizzyT《蝴蝶效应》巡演@广州/素材/FX3#1/
FX3#1/
├── CARD#A
│   ├── AVF_INFO
│   ├── M4ROOT
...
```bash
$ cd '/Volumes/GSJ#543/TizzyT「蝴蝶效应」巡演纪录/素材/250628-TizzyT《蝴蝶效应》巡演@广州'
$ xxh64sum **/*{MP4,mp4}
